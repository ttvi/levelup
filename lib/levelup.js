...
LevelUP.prototype.compactRange = function(start, end, callback) {
  if (!this.isOpen()) {
    return callback(new ReadError('Database is not open'));
  }
  return this._db.compactRange(start, end, callback);
}
